...
#define ARCHIVE_SVN " 1"

/* How and when GNU APL was configured */
#define BUILDTAG PACKAGE_NAME, PACKAGE_VERSION " / SVN: 37", "2023-04-04 17:33:30 UTC", "Linux 5.15.0-69-generic x86_64", "default ./configure options"
