...
#define ARCHIVE_SVN " 534"

/* How and when GNU APL was configured */
#define BUILDTAG PACKAGE_NAME, PACKAGE_VERSION " / SVN: 785", "2023-07-30 16:49:23 UTC", "Linux 5.15.0-78-generic x86_64", "default ./configure options"
