...
#define ARCHIVE_SVN " 146"

/* How and when GNU APL was configured */
#define BUILDTAG PACKAGE_NAME, PACKAGE_VERSION " / SVN: 151", "2023-04-18 18:00:59 UTC", "Linux 5.15.0-69-generic x86_64", "default ./configure options"
