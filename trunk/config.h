...
#define ARCHIVE_SVN " 378"

/* How and when GNU APL was configured */
#define BUILDTAG PACKAGE_NAME, PACKAGE_VERSION " / SVN: 381", "2023-06-03 14:38:43 UTC", "Linux 5.15.0-72-generic x86_64", "default ./configure options"
