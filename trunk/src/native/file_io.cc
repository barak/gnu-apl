...
u8"   Assumes 'lib_file_io.so'  ⎕FX  'FUN'\n"
"\n"
...
"\n"
u8"   Zi ←    FUN[ 1] ''    errno (of last call)\n"
u8"   Zs ←    FUN[ 2] Be    strerror(Be)\n"
u8"   Zh ← As FUN[ 3] Bs    fopen(Bs, As) filename Bs mode As\n"
u8"   Zh ←    FUN[ 3] Bs    fopen(Bs, \"r\") filename Bs\n"
"\n"
"File I/O functions:\n"
"\n"
u8"   Ze ←    FUN[ 4] Bh    fclose(Bh)\n"
u8"   Ze ←    FUN[ 5] Bh    errno (of last call on Bh)\n"
u8"   Zi ←    FUN[ 6] Bh    fread(Zi, 1, " << SMALL_BUF << ", Bh) 1 byte per Zi\n"
u8"   Zi ← Ai FUN[ 6] Bh    fread(Zi, 1, Ai, Bh) 1 byte per Zi\n"
u8"   Zi ← Ai FUN[ 7] Bh    fwrite(Ai, 1, ⍴Ai, Bh) 1 byte per Ai\n"
u8"   Zi ←    FUN[ 8] Bh    fgets(Zi, " << SMALL_BUF << ", Bh) 1 byte per Zi\n"
u8"   Zi ← Ai FUN[ 8] Bh    fgets(Zi, Ai, Bh) 1 byte per Zi\n"
u8"   Zi ←    FUN[ 9] Bh    fgetc(Zi, Bh) 1 byte\n"
u8"   Zi ←    FUN[10] Bh    feof(Bh)\n"
u8"   Zi ←    FUN[11] Bh    ferror(Bh)\n"
u8"   Zi ←    FUN[12] Bh    ftell(Bh)\n"
u8"   Zi ← Ai FUN[13] Bh    fseek(Bh, Ai, SEEK_SET)\n"
u8"   Zi ← Ai FUN[14] Bh    fseek(Bh, Ai, SEEK_CUR)\n"
u8"   Zi ← Ai FUN[15] Bh    fseek(Bh, Ai, SEEK_END)\n"
u8"   Zi ←    FUN[16] Bh    fflush(Bh)\n"
u8"   Zi ←    FUN[17] Bh    fsync(Bh)\n"
u8"   Zi ←    FUN[18] Bh    fstat(Bh)\n"
u8"   Zi ←    FUN[19] Bh    unlink(Bc)\n"
u8"   Zi ←    FUN[20] Bh    mkdir(Bc, 0777)\n"
u8"   Zi ← Ai FUN[20] Bh    mkdir(Bc, AI)\n"
u8"   Zi ←    FUN[21] Bh    rmdir(Bc)\n"
u8"   Zi ← A  FUN[22] 1     printf(         A1, A2...) format A1\n"
u8"   Zi ← A  FUN[22] 2     fprintf(stderr, A1, A2...) format A1\n"
u8"   Zi ← A  FUN[22] Bh    fprintf(Bh,     A1, A2...) format A1\n"
u8"   Zi ← Ac FUN[23] Bh    fwrite(Ac, 1, ⍴Ac, Bh) 1 Unicode per Ac, Output UTF8\n"
u8"   Zh ← As FUN[24] Bs    popen(Bs, As) command Bs mode As\n"
u8"   Zh ←    FUN[24] Bs    popen(Bs, \"r\") command Bs\n"
u8"   Ze ←    FUN[25] Bh    pclose(Bh)\n"
u8"   Zs ←    FUN[26] Bs    return entire file Bs as byte vector\n"
u8"   Zs ← As FUN[27] Bs    rename file As to Bs\n"
u8"   Zd ←    FUN[28] Bs    return content of directory Bs\n"
u8"   Zn ←    FUN[29] Bs    return file names in directory Bs\n"
u8"   Zs ←    FUN 30        getcwd()\n"
u8"   Zn ← As FUN[31] Bs    access(As, Bs) As ∈ 'RWXF'\n"
u8"   Zh ←    FUN[32] Bi    socket(Bi=AF_INET, SOCK_STREAM, 0)\n"
u8"   Ze ← Aa FUN[33] Bh    bind(Bh, Aa)\n"
u8"   Ze ←    FUN[34] Bh    listen(Bh, 10)\n"
u8"   Ze ← Ai FUN[34] Bh    listen(Bh, Ai)\n"
u8"   Za ←    FUN[35] Bh    accept(Bh)\n"
u8"   Ze ← Aa FUN[36] Bh    connect(Bh, Aa)\n"
u8"   Zi ←    FUN[37] Bh    recv(Bh, Zi, " << SMALL_BUF << ", 0) 1 byte per Zi\n"
u8"   Zi ← Ai FUN[37] Bh    recv(Bh, Zi, Ai, 0) 1 byte per Zi\n"
u8"   Zi ← Ai FUN[38] Bh    send(Bh, Ai, ⍴Ai, 0) 1 byte per Ai\n"
u8"   Zi ← Ac FUN[39] Bh    send(Bh, Ac, ⍴Ac, 0) 1 Unicode per Ac, Output UTF8\n"
u8"   Zi ←    FUN[40] B     select(B_read, B_write, B_exception, B_timeout)\n"
u8"   Zi ←    FUN[41] Bh    read(Bh, Zi, " << SMALL_BUF << ") 1 byte per Zi\n"
u8"   Zi ← Ai FUN[41] Bh    read(Bh, Zi, Ai) 1 byte per Zi\n"
u8"   Zi ← Ai FUN[42] Bh    write(Bh, Ai, ⍴Ai) 1 byte per Ai\n"
u8"   Zi ← Ac FUN[43] Bh    write(Bh, Ac, ⍴Ac) 1 Unicode per Ac, Output UTF8\n"
u8"   Za ←    FUN[44] Bh    getsockname(Bh)\n"
u8"   Za ←    FUN[45] Bh    getpeername(Bh)\n"
u8"   Zi ← Ai FUN[46] Bh    getsockopt(Bh, A_level, A_optname, Zi)\n"
u8"   Ze ← Ai FUN[47] Bh    setsockopt(Bh, A_level, A_optname, A_optval)\n"
"\n"
"Benchmarking functions:\n"
"\n"
"           FUN[200] Bi    clear statistics with ID Bi\n"
u8"   Zn ←    FUN[201] Bi    get statistics with ID Bi\n"
