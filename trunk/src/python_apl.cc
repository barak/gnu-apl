...
shape_for_item(PyObject * item)
{
   ...
   if (PyTuple_Size(item) != 2)
      {
        CERR << u8"*** tuple len ≠ 2 at " LOC << endl;
        return Shape();
      }
...
u8"    tuple(4, value)        if the expression returned a branch (e.g. →N)\n"
u8"    tuple(5, value)        if the expression returned branch escape (→)\n"
"\n"
u8"Note: Result has the same format as ⎕EC (execute controlled)\n"
;

const char * DESCR_fix_function =
u8"gnu_apl.fix_function() : create (aka. ⎕FX) a new defined APL function, or\n"
...
u8"    The first line in text is the function signature, e.g. Z←A myfun B\n"
...
u8"    int(N)     if the body line N ≥ 1 was incorrect.\n"
"    int(-1)    if something else went wrong.\n"
"\n"
u8"NOTE: creating or modifying defined APL functions with ⎕FX (in APL) or by\n"
...
u8"    the standard APL ∇-editor (in interactive APL sessions) or to write APL\n"
...
"\n"
"Result:\n"
u8"   on sucess:   list [ i₁, i₂, ... iN ] where N is the length of the\n"
...
"\n"
"Result:\n"
u8"    on sucess:   list [ r₁, r₂, ... rR ] where R is the number of axes\n"
...
"\n"
u8"╔═══════════════════════════╤══╤════════════╤═══════════════════════════════╗\n"
u8"║ Python value              │  │ APL value  │ Remark                        ║\n"
u8"╠═══════════════════════════╪══╪════════════╪════════════╤══════════════════╣\n"
u8"║ int(65)                   │ →│ 65         │            │ Integer          ║\n"
u8"╟───────────────────────────┼──┼────────────┤            ├──────────────────╢\n"
u8"║ float(6.5)                │ →│ 6.5        │            │ Floating point   ║\n"
u8"╟───────────────────────────┼──┼────────────┤ APL Scalar ├──────────────────╢\n"
u8"║ complex(6, 5)             │ →│ 6J5        │            │ Complex          ║\n"
u8"╟───────────────────────────┼──┼────────────┤            ├──────────────────╢\n"
u8"║ chr(65) or 'A'            │ →│ 'A'        │            │ single Unicode   ║\n"
u8"╠═══════════════════════════╪══╪════════════╪════════════╪══════════════════╣\n"
u8"║ list([6, 5, 'A'])         │ →│ 6 5 'A'    │            │ Mixed            ║\n"
u8"╟───────────────────────────┼──┼────────────┤ APL Vector ├──────────────────╢\n"
u8"║ str('string')             │ →│ 'string'   │            │ Character        ║\n"
u8"╠═══════════════════════════╪══╪════════════╪════════════╪══════════════════╣\n"
u8"║ tuple([65],  [])          │←→│ 65         │ APL Scalar │ Integer          ║\n"
u8"║ tuple([6.5], [])          │←→│ 6.5        │ (as above) │ Floating point   ║\n"
u8"║ tuple([6J5], [])          │←→│ 6J5        │ in tuple() │ Complex          ║\n"
u8"║ tuple(['A'], [])          │←→│ 'A'        │ format     │ single Unicode   ║\n"
u8"╟───────────────────────────┼──┼────────────┼────────────┴──────────────────╢\n"
u8"║ tuple([6, 5, 'A'], [3])   │←→│ 6 5 'A'    │ Vector of length 3 (as above) ║\n"
u8"╟───────────────────────────┼──┼────────────┼───────────────────────────────╢\n"
u8"║ ravel = [6, 5, 'A']       │  │ 6 5 'A'    │ 2×3 Matrix. The ravel is      ║\n"
u8"║ shape = [2, 3]            │←→│ 6 5 'A'    │ truncated or repeated as      ║\n"
u8"║ tuple(ravel, shape)       │  │            │ needed to fill the shape      ║\n"
u8"╟───────────────────────────┼──┼────────────┼───────────────────────────────╢\n"
u8"║ any non-scalar array item │  │ nested APL │ 3-element vector with nested  ║\n"
u8"║ (such as str() or list()  │  │ array      │ second element which is the   ║\n"
u8"║ or tuple() above)         │  │            │ 2-element sub-vector 2 3      ║\n"
u8"║ [1 [2, 3] 4]              │←→│ 1 (2 3) 4  │                               ║\n"
u8"╚═══════════════════════════╧══╧════════════╧═══════════════════════════════╝\n"
"\n"
u8"NOTE: Every non-tuple() variant (like str('string') or list([i₁, i₂, ...])\n"
...
u8"      shortcuts work only in the Python → APL direction; values in the\n"
u8"      APL → Python direction are always returned in the tuple() format.\n"
;
...
"\n"
"Examples:\n"
u8"    gnu_apl.set_value('Var', 65)                # Var ← 65\n"
u8"    gnu_apl.set_value('Var', 6.5)               # Var ← 6.5\n"
u8"    gnu_apl.set_value('Var', 6J5)               # Var ← 6J5\n"
u8"    gnu_apl.set_value('Var', [6, 5, 'A'])       # Var ← 6 5 'A'\n"
u8"    gnu_apl.set_value('Var', [1, [2, 3], 4])    # Var ← 1 (2 3) 4\n"
;
