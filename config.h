...
/* --bindir */
#define apl_DIR__bin "/usr/bin"

/* --datarootdir */
#define apl_DIR__datarootdir "/usr/share"

/* --docdir */
#define apl_DIR__doc "/usr/share/doc/apl"

/* --exec_prefix */
#define apl_DIR__exec_prefix "/usr"

/* --libdir */
#define apl_DIR__lib "/usr/lib64"

/* --localedir */
#define apl_DIR__locale "/usr/share/locale"

/* installation directory for GNU APL libraries */
#define apl_DIR__pkglib "/usr/lib64/apl"
...
#define cfg_CONFIGURE_ARGS "./configure  '--host=x86_64-pc-linux-gnu' '--build=x86_64-pc-linux-gnu' '--program-prefix=' '--disable-dependency-tracking' '--prefix=/usr' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--sysconfdir=/etc' '--datadir=/usr/share' '--includedir=/usr/include' '--libdir=/usr/lib64' '--libexecdir=/usr/libexec' '--localstatedir=/var' '--sharedstatedir=/usr/com' '--mandir=/usr/share/man' '--infodir=/usr/share/info' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-pc-linux-gnu' 'CFLAGS=-O2 -g' 'LDFLAGS=' 'CXXFLAGS=-O2 -g'"
